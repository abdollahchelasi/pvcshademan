            ...
            <Col sm={6}>
              <Container>
                ...
                <Row className={styles.upvcimg}>
                  ...
                  <Col >
                    <p className={styles.pp}>
                      پنل دکوراتیو ساخت ترکیه..قابل اجرا برای درب سرویس.حمام.راهرو.ورودی و.....با عرض 90 سانت ب پایین
                    </p>
            ...
            <Col sm={6}>
              <Container>
                ...
                <Row className={styles.upvcimg}>
                  ...
                  <Col >
                    <p className={styles.pp}>
                      پنل دکوراتیو ساخت ترکیه..قابل اجرا برای درب سرویس.حمام.راهرو.ورودی و.....با عرض 78 سانت ب پایین
                    </p>
